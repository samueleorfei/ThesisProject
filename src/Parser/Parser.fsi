...
/// albero di sintassi (<code>AST<'T></code>) partendo da una lista di <code>Token</code> generata dal _Lexer_.
///
module Parser =
    ...
    /// restituisce la rappresentazione interna dell'espressione booleana data da un albero di sintassi (<code>AST<'T></code>)
    ///
    /// ---
    ///
    /// **Parameters**
    ...
    /// **Return**
    ///
    /// - <code>Result<(AST<string> * Token<string> list), ParseError></code>
    ///
